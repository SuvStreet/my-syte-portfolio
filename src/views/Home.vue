        ...
        <div class="row">
          <div class="home-info padd-15">
            ...
            <h3 class="my-profession">
              Я <span class="typing">веб-разработчик</span>
            </h3>
            <p>
              Я трудолюбивый и заинтересованный веб-разработчик. Мне нравится
              ...
              На данный момент у меня уже есть опыть работы с Vue.js и React.js.
              Не собираюсь на этом останавливаться и продолжу искать опыт в
              разных проектах...
            </p>
